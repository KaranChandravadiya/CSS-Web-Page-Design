...
const LiveJobs = () => {
    ...
    const cardData = [
        ...
        { title: "UI Designer", organisation: "10.11 Design", location: "Makarba, Ahmedabad", vacancy: "05 Vacancy" },
        { title: "UI Designer", organisation: "10.11 Design", location: "Makarba, Ahmedabad", vacancy: "05 Vacancy", isApplied: true },
        { title: "Frontend Developer", organisation: "Tata Consultancy services", location: "Satellite, Ahmedabad", vacancy: "01 Vacancy" },
        { title: "Product Designer", organisation: "Think Design", location: "Bopal, Ahmedabad", vacancy: "03 Vacancy" },
        { title: "UI Designer", organisation: "10.11 Design", location: "Makarba, Ahmedabad", vacancy: "05 Vacancy" },
    ]
                ...
                <div className="RecommendedMainDivs">
                    <div className='JobsCard'>
                        {cardData.map(({ title, organisation, location, vacancy, isApplied }, index) => (
                            <div className={`live-jobs-card ${isApplied ? "applied" : ""}`} key={index}>
